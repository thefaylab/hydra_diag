---
title: "Hydra diagnostics-5 bins from mskeyrun simulated data"
...
u <- ("https://github.com/thefaylab/hydra_sim/blob/sarah/inputRdatalists/hydraDataList_5bin.rds?raw=true")
...
```{r}
repfile <- "https://github.com/thefaylab/hydra_sim/blob/sarah/results/05bin/hydra_sim.rep?raw=true"
